...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			leaveapplication.Table:           leaveapplication.ValidColumn,
			leavebalance.Table:               leavebalance.ValidColumn,
			...
			workflowdelegation.Table:         workflowdelegation.ValidColumn,
			workflowinstance.Table:           workflowinstance.ValidColumn,
			workflowinstancejoin.Table:       workflowinstancejoin.ValidColumn,
			workflowinstanceparentlink.Table: workflowinstanceparentlink.ValidColumn,
