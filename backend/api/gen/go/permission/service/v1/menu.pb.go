...
import (
	...
	v1 "go-wind-oa/api/gen/go/identity/service/v1"
...
const file_permission_service_v1_menu_proto_rawDesc = "" +
	...
	"\x06module\x18\x10 \x01(\x0e2\x1b.identity.service.v1.ModuleB!\xe0A\x01\xbaG\x1b\x92\x02\x18所属业务功能模块H\n" +
	"R\x06module\x88\x01\x01\x12;\n" +
	"\n" +
	...
	"\tSyncMenus\x12'.permission.service.v1.SyncMenusRequest\x1a\x16.google.protobuf.Empty\"\x00B\xd6\x01\n" +
	"\x19com.permission.service.v1B\tMenuProtoP\x01Z8go-wind-oa/api/gen/go/permission/service/v1;permissionpb\xa2\x02\x03PSX\xaa\x02\x15Permission.Service.V1\xca\x02\x15Permission\\Service\\V1\xe2\x02!Permission\\Service\\V1\\GPBMetadata\xea\x02\x17Permission::Service::V1b\x06proto3"
...
var file_permission_service_v1_menu_proto_depIdxs = []int32{
	...
	12, // 4: permission.service.v1.Menu.module:type_name -> identity.service.v1.Module
