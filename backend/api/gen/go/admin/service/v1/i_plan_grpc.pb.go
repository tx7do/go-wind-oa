...
const (
	PlanService_List_FullMethodName   = "/admin.service.v1.PlanService/List"
	PlanService_Get_FullMethodName    = "/admin.service.v1.PlanService/Get"
	PlanService_Create_FullMethodName = "/admin.service.v1.PlanService/Create"
	PlanService_Update_FullMethodName = "/admin.service.v1.PlanService/Update"
	PlanService_Delete_FullMethodName = "/admin.service.v1.PlanService/Delete"
)
...
type PlanServiceClient interface {
	// 分页查询套餐列表
	List(ctx context.Context, in *v1.PagingRequest, opts ...grpc.CallOption) (*v11.ListPlanResponse, error)
	// 查询套餐详情
	Get(ctx context.Context, in *v11.GetPlanRequest, opts ...grpc.CallOption) (*v11.Plan, error)
	// 创建套餐
	Create(ctx context.Context, in *v11.CreatePlanRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// 更新套餐
	Update(ctx context.Context, in *v11.UpdatePlanRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// 删除套餐
	Delete(ctx context.Context, in *v11.DeletePlanRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *planServiceClient) List(ctx context.Context, in *v1.PagingRequest, opts ...grpc.CallOption) (*v11.ListPlanResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v11.ListPlanResponse)
...
func (c *planServiceClient) Get(ctx context.Context, in *v11.GetPlanRequest, opts ...grpc.CallOption) (*v11.Plan, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v11.Plan)
...
func (c *planServiceClient) Create(ctx context.Context, in *v11.CreatePlanRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *planServiceClient) Update(ctx context.Context, in *v11.UpdatePlanRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (c *planServiceClient) Delete(ctx context.Context, in *v11.DeletePlanRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (UnimplementedPlanServiceServer) List(context.Context, *v1.PagingRequest) (*v11.ListPlanResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method List not implemented")
}
func (UnimplementedPlanServiceServer) Get(context.Context, *v11.GetPlanRequest) (*v11.Plan, error) {
	return nil, status.Error(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedPlanServiceServer) Create(context.Context, *v11.CreatePlanRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedPlanServiceServer) Update(context.Context, *v11.UpdatePlanRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedPlanServiceServer) Delete(context.Context, *v11.DeletePlanRequest) (*emptypb.Empty, error) {
...
func _PlanService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlanServiceServer).Get(ctx, req.(*v11.GetPlanRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PlanService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlanServiceServer).Create(ctx, req.(*v11.CreatePlanRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PlanService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlanServiceServer).Update(ctx, req.(*v11.UpdatePlanRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PlanService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlanServiceServer).Delete(ctx, req.(*v11.DeletePlanRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PlanService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "admin.service.v1.PlanService",
	...
	Metadata: "admin/service/v1/i_plan.proto",
}
