...
const file_admin_service_v1_admin_doc_proto_rawDesc = "" +
	"\n" +
	" admin/service/v1/admin_doc.proto\x12\x10admin.service.v1\x1a$gnostic/openapi/v3/annotations.protoB\xad\x06\xbaG\xf2\x04\x12\xba\x01\n" +
	"\x13GoWind OA Admin API\x12\x13GoWind OA Admin API\"A\n" +
	...
	"\x14com.admin.service.v1B\rAdminDocProtoP\x01Z.go-wind-oa/api/gen/go/admin/service/v1;adminpb\xa2\x02\x03ASX\xaa\x02\x10Admin.Service.V1\xca\x02\x10Admin\\Service\\V1\xe2\x02\x1cAdmin\\Service\\V1\\GPBMetadata\xea\x02\x12Admin::Service::V1b\x06proto3"
