...
import (
	...
	v11 "go-wind-oa/api/gen/go/storage/service/v1"
...
const file_admin_service_v1_i_file_proto_rawDesc = "" +
	...
	"\x06Delete\x12%.storage.service.v1.DeleteFileRequest\x1a\x16.google.protobuf.Empty\"\x1c\x82\xd3\xe4\x93\x02\x16*\x14/admin/v1/files/{id}B\xb4\x01\n" +
	"\x14com.admin.service.v1B\n" +
	"IFileProtoP\x01Z.go-wind-oa/api/gen/go/admin/service/v1;adminpb\xa2\x02\x03ASX\xaa\x02\x10Admin.Service.V1\xca\x02\x10Admin\\Service\\V1\xe2\x02\x1cAdmin\\Service\\V1\\GPBMetadata\xea\x02\x12Admin::Service::V1b\x06proto3"
