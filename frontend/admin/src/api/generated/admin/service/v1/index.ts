...
export interface AttendanceService {
  ...
  ListAttendanceRecords(
    request: oaservicev1_ListAttendanceRecordsRequest,
  ): Promise<oaservicev1_ListAttendanceRecordsResponse>;
  // 读取考勤设置
  GetAttendanceSetting(
    request: wellKnownEmpty,
  ): Promise<oaservicev1_AttendanceSetting>;
  // 更新考勤设置
  UpdateAttendanceSetting(
    request: oaservicev1_AttendanceSetting,
  ): Promise<wellKnownEmpty>;
...
export function createAttendanceServiceClient(
  ...
  return {
    ListAttendanceRecords(request) {
      const path = `admin/v1/oa/attendance/records`;
      const body = null;
      const queryParams: string[] = [];
      if (request.workDate) {
        queryParams.push(
          `workDate=${encodeURIComponent(request.workDate.toString())}`,
        );
      }
      if (request.userId) {
        queryParams.push(
      ...
      }) as Promise<oaservicev1_ListAttendanceRecordsResponse>;
    },
    GetAttendanceSetting(_request) {
      const path = `admin/v1/oa/attendance/settings`;
      const body = null;
      return transport.unary(path, 'GET', body, {
        service: 'AttendanceService',
        method: 'GetAttendanceSetting',
      }) as Promise<oaservicev1_AttendanceSetting>;
    },
    UpdateAttendanceSetting(request) {
      const path = `admin/v1/oa/attendance/settings`;
      const body = JSON.stringify(request);
      return transport.unary(path, 'PUT', body, {
        service: 'AttendanceService',
        method: 'UpdateAttendanceSetting',
      }) as Promise<wellKnownEmpty>;
    },
    RunDailySettlement(request) {
      const path = `admin/v1/oa/attendance/settlements`;
      const body = JSON.stringify(request);
      return transport.unary(path, 'POST', body, {
        service: 'AttendanceService',
...
// 查询记录 - 回应
export type oaservicev1_ListAttendanceRecordsResponse = {
  items: oaservicev1_AttendanceRecord[] | undefined;
  total: number | undefined;
};

// 打卡记录（用户 x 工作日 唯一）
export type oaservicev1_AttendanceRecord = {
  checkInAt?: wellKnownTimestamp;
  checkInLatitude?: number;
  checkInLongitude?: number;
  checkInWifiBssid?: string;
  checkOutAt?: wellKnownTimestamp;
  checkOutLatitude?: number;
  checkOutLongitude?: number;
  checkOutWifiBssid?: string;
  createdAt?: wellKnownTimestamp;
  createdBy?: number;
  dayResult?: oaservicev1_AttendanceRecord_DayResult;
  //
  // Behaviors: OPTIONAL
  id?: number;
  tenantId?: number;
  ...
  userId?: number;
  userName?: string;
  workDate?: wellKnownTimestamp;
};

// 当日结算结果
export type oaservicev1_AttendanceRecord_DayResult =
  | 'ABSENT'
  | 'EARLY_LEAVE'
  | 'LATE'
  | 'NORMAL'
  ...
  | 'PENDING';
// 考勤设置（每租户一行）
export type oaservicev1_AttendanceSetting = {
  createdAt?: wellKnownTimestamp;
  //
  // Behaviors: OPTIONAL
  id?: number;
...
// 工作日结算 - 请求（admin）
export type oaservicev1_RunDailySettlementRequest = {
  workDate: undefined | wellKnownTimestamp;
};
...
export interface ExpenseService {
  // 查询报销申请列表
  ListExpenseApplications(
    request: oaservicev1_ListExpenseApplicationsRequest,
  ): Promise<oaservicev1_ListExpenseApplicationsResponse>;
  // 查询报销申请详情
  GetExpenseApplication(
    request: oaservicev1_GetExpenseApplicationRequest,
  ): Promise<oaservicev1_ExpenseApplication>;
}
...
export function createExpenseServiceClient(
  ...
  return {
    ListExpenseApplications(request) {
      const path = `admin/v1/oa/expense/applications`;
      const body = null;
      const queryParams: string[] = [];
      if (request.userId) {
        queryParams.push(
      ...
      }) as Promise<oaservicev1_ListExpenseApplicationsResponse>;
    },
    GetExpenseApplication(request) {
      if (request.id === undefined || request.id === null) {
        throw new Error('missing required field request.id');
      }
      const path = `admin/v1/oa/expense/applications/${request.id}`;
      const body = null;
      return transport.unary(path, 'GET', body, {
        service: 'ExpenseService',
        method: 'GetExpenseApplication',
      }) as Promise<oaservicev1_ExpenseApplication>;
    },
  };
}
// 查询报销申请 - 请求
...
// 申请单状态（与工作流实例终态同步）
export type oaservicev1_ExpenseApplication_ExpenseStatus =
  | 'APPROVED'
  | 'PENDING'
  | 'REJECTED'
  | 'WITHDRAWN';
// 查询报销申请 - 回应
export type oaservicev1_ListExpenseApplicationsResponse = {
  items: oaservicev1_ExpenseApplication[] | undefined;
  total: number | undefined;
};

// 报销申请单
export type oaservicev1_ExpenseApplication = {
  applicantName?: string;
  createdAt?: wellKnownTimestamp;
  createdBy?: number;
  deletedAt?: wellKnownTimestamp;
  deletedBy?: number;
  expenseStatus?: oaservicev1_ExpenseApplication_ExpenseStatus;
  //
  // Behaviors: OPTIONAL
  id?: number;
  instanceId?: number;
  items: oaservicev1_ExpenseItem[] | undefined;
  tenantId?: number;
  title?: string;
  totalAmount?: number;
  updatedAt?: wellKnownTimestamp;
...
// 报销明细行
export type oaservicev1_ExpenseItem = {
  amount?: number;
  category?: string;
  createdAt?: wellKnownTimestamp;
  description?: string;
  expenseDate?: wellKnownTimestamp;
  //
  // Behaviors: OPTIONAL
  id?: number;
...
// 查询报销申请详情 - 请求
export type oaservicev1_GetExpenseApplicationRequest = {
  id: number | undefined;
};
...
export interface LeaveService {
  // 创建请假类型
  CreateLeaveType(
    request: oaservicev1_CreateLeaveTypeRequest,
  ): Promise<oaservicev1_LeaveType>;
  // 查询请假类型列表
  ListLeaveTypes(
    request: pagination_PagingRequest,
  ): Promise<oaservicev1_ListLeaveTypesResponse>;
  // 授予/调整用户假期额度
  GrantLeaveBalance(
    request: oaservicev1_GrantLeaveBalanceRequest,
  ): Promise<wellKnownEmpty>;
  // 查询假期额度
  ListLeaveBalances(
    request: oaservicev1_ListLeaveBalancesRequest,
  ): Promise<oaservicev1_ListLeaveBalancesResponse>;
  // 查询请假申请列表
  ListLeaveApplications(
    request: oaservicev1_ListLeaveApplicationsRequest,
  ): Promise<oaservicev1_ListLeaveApplicationsResponse>;
  // 查询请假申请详情
  GetLeaveApplication(
    request: oaservicev1_GetLeaveApplicationRequest,
  ): Promise<oaservicev1_LeaveApplication>;
}
...
export function createLeaveServiceClient(
  ...
  return {
    CreateLeaveType(request) {
      const path = `admin/v1/oa/leave/types`;
      const body = JSON.stringify(request);
      return transport.unary(path, 'POST', body, {
        service: 'LeaveService',
        method: 'CreateLeaveType',
      }) as Promise<oaservicev1_LeaveType>;
    },
    ListLeaveTypes(request) {
      const path = `admin/v1/oa/leave/types`;
      const body = null;
      const queryParams: string[] = [];
      if (request.page) {
      ...
      }) as Promise<oaservicev1_ListLeaveTypesResponse>;
    },
    GrantLeaveBalance(request) {
      const path = `admin/v1/oa/leave/balances`;
      const body = JSON.stringify(request);
      return transport.unary(path, 'POST', body, {
        service: 'LeaveService',
        method: 'GrantLeaveBalance',
      }) as Promise<wellKnownEmpty>;
    },
    ListLeaveBalances(request) {
      const path = `admin/v1/oa/leave/balances`;
      const body = null;
      const queryParams: string[] = [];
      if (request.userId) {
      ...
      }) as Promise<oaservicev1_ListLeaveBalancesResponse>;
    },
    ListLeaveApplications(request) {
      const path = `admin/v1/oa/leave/applications`;
      const body = null;
      const queryParams: string[] = [];
      if (request.userId) {
        queryParams.push(
      ...
      }) as Promise<oaservicev1_ListLeaveApplicationsResponse>;
    },
    GetLeaveApplication(request) {
      if (request.id === undefined || request.id === null) {
        throw new Error('missing required field request.id');
      }
      const path = `admin/v1/oa/leave/applications/${request.id}`;
      const body = null;
      return transport.unary(path, 'GET', body, {
        service: 'LeaveService',
        method: 'GetLeaveApplication',
      }) as Promise<oaservicev1_LeaveApplication>;
    },
  };
}
// 创建请假类型 - 请求
export type oaservicev1_CreateLeaveTypeRequest = {
  data: oaservicev1_LeaveType | undefined;
};

// 请假类型（年假/病假/事假等，租户内 code 唯一）
export type oaservicev1_LeaveType = {
  code?: string;
  createdAt?: wellKnownTimestamp;
  createdBy?: number;
  deletedAt?: wellKnownTimestamp;
...
// 查询请假类型列表 - 回应
export type oaservicev1_ListLeaveTypesResponse = {
  items: oaservicev1_LeaveType[] | undefined;
  total: number | undefined;
};

// 授予额度 - 请求
export type oaservicev1_GrantLeaveBalanceRequest = {
...
// 查询额度 - 回应
export type oaservicev1_ListLeaveBalancesResponse = {
  items: oaservicev1_LeaveBalance[] | undefined;
  total: number | undefined;
};

// 假期额度（用户 x 类型 x 年度）
export type oaservicev1_LeaveBalance = {
  createdAt?: wellKnownTimestamp;
  createdBy?: number;
  deletedAt?: wellKnownTimestamp;
  deletedBy?: number;
...
// 申请单状态（与工作流实例终态同步）
export type oaservicev1_LeaveApplication_LeaveStatus =
  | 'APPROVED'
  | 'PENDING'
  | 'REJECTED'
  | 'WITHDRAWN';
// 查询请假申请 - 回应
export type oaservicev1_ListLeaveApplicationsResponse = {
  items: oaservicev1_LeaveApplication[] | undefined;
  total: number | undefined;
};

// 请假申请单
export type oaservicev1_LeaveApplication = {
  applicantName?: string;
  createdAt?: wellKnownTimestamp;
  createdBy?: number;
  days?: number;
  ...
  deletedBy?: number;
  endDate?: wellKnownTimestamp;
  endHalf?: oaservicev1_HalfOfDay;
  //
  // Behaviors: OPTIONAL
  id?: number;
  instanceId?: number;
  leaveStatus?: oaservicev1_LeaveApplication_LeaveStatus;
  leaveTypeId?: number;
  leaveTypeName?: string;
  reason?: string;
  startDate?: wellKnownTimestamp;
  startHalf?: oaservicev1_HalfOfDay;
  tenantId?: number;
  updatedAt?: wellKnownTimestamp;
  updatedBy?: number;
};
...
// 半日粒度（请假起止）
export type oaservicev1_HalfOfDay =
  | 'AM'
  | 'PM';
// 查询请假申请详情 - 请求
export type oaservicev1_GetLeaveApplicationRequest = {
  id: number | undefined;
};
...
export function createWorkflowServiceClient(
  ...
  return {
    ...
    AuditTask(request) {
      const path = `admin/v1/oa/workflow/audit-task`;
      const body = JSON.stringify(request);
      return transport.unary(path, 'POST', body, {
        service: 'WorkflowService',
        method: 'AuditTask',
    ...
    GetTask(request) {
      ...
      const path = `admin/v1/oa/workflow/tasks/${request.id}`;
      const body = null;
      return transport.unary(path, 'GET', body, {
        service: 'WorkflowService',
        method: 'GetTask',
...
// 任务列表类型
export type oaservicev1_ListType =
  | 'DONE'
  | 'PENDING'
  | 'SUBMITTED';
// 查询我的任务 - 回应
...
export type oaservicev1_GetTaskResponse = {
  formData?: string;
  logs: oaservicev1_WorkflowLog[] | undefined;
  task?: oaservicev1_WorkflowTask;
};

// 审批任务
export type oaservicev1_WorkflowTask = {
...
// 任务状态
export type oaservicev1_WorkflowTask_TaskStatus =
  | 'APPROVED'
  | 'CANCELLED'
  | 'PENDING'
  | 'REJECTED';
// 审批日志
export type oaservicev1_WorkflowLog = {
  comment?: string;
  createdAt?: wellKnownTimestamp;
  createdBy?: number;
  deletedAt?: wellKnownTimestamp;
...
export class ApiClient {
  ...
  get expenseService(): ExpenseService {
    return this._expenseService ??= createExpenseServiceClient(this._transport);
  }
  ...
  get leaveService(): LeaveService {
    return this._leaveService ??= createLeaveServiceClient(this._transport);
  }
