...
| Internal Messaging | Approval notifications persisted, inbox query, SSE push | ✅ |
...
- `src/pages/app/oa/` — approval center, attendance records, holiday setup, leave management, expense management, process-definition editor.
...
- `lib/src/features/oa/services/` — business services (workflow / attendance / leave / expense / file_upload / notification).
- `lib/src/features/oa/pages/` — login, approval task list & detail, submit application (dynamic form), attendance check-in, leave, expense, notifications.
